...
export const RELATION_TYPES: {
...
}[] = [
  {
    value: 'reports_to',
    label: '向其汇报',
    description: '发起方是下属，接收方是负责人',
  },
  {
    value: 'peer',
    label: '同事协作',
    description: '同级协商、并行或顺序交接任务',
  },
  {
    value: 'advisor',
    label: '顾问咨询',
    description: '向对方征询意见与风险判断',
  },
  {
    value: 'reviewer',
    label: '复核关系',
    description: '向对方提交结果并接受质疑',
  },
  {
    value: 'oversight',
    label: '监督关系',
    description: '对对方进行审计、质询与升级',
  },
  {
    value: 'representative',
    label: '代表关系',
    description: '允许对方代表发起方参与沟通',
  },
  {
    value: 'opponent',
    label: '对抗关系',
    description: '目标冲突，允许挑战但仍受规则约束',
  },
